                    ...
                    <table class="MuiTable-root css-1owb465" style={{width: '100%'}}> 
                        <thead class="MuiTableHead-root css-1wbz3t9">
                            <tr class="MuiTableRow-root MuiTableRow-head css-1gqug66" style={{borderBottom:"1px solid black"}}>
                                ...
                                <th class="MuiTableCell-root MuiTableCell-head MuiTableCell-sizeSmall css-12pjbv5" scope="col" style={{textAlign:'center'}}>Amounts Earned on Behalf of Client</th>
                            </tr>
                        </thead>
                        <tbody class="MuiTableBody-root css-1xnox0e">
                            <tr class="MuiTableRow-root css-1gqug66" style={{borderBottom:"1px solid black"}}>
                                ...
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>15 Mar, 2022</td>
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>$76,100.21</td>
                            ...
                            <tr class="MuiTableRow-root css-1gqug66">
                                ...
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>06 Jun, 2022</td>
                            ...
                            <tr class="MuiTableRow-root css-1gqug66">
                                ...
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>08 July, 2021</td>
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>$56,391.28</td>
                            ...
                            <tr class="MuiTableRow-root css-1gqug66">
                                ...
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>24 Mar, 2021</td>
                            ...
                            <tr class="MuiTableRow-root css-1gqug66">
                                ...
                                <td class="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-1o6fzn1" style={{textAlign:'center'}}>17 Jan, 2022</td>
